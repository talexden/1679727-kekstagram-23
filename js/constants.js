...
const SCALE_CONTROL_SMALLER = IMG_UPLOAD_SCALE.querySelector('.scale__control--smaller');
const SCALE_CONTROL_BIGGER = IMG_UPLOAD_SCALE.querySelector('.scale__control--bigger');
